...
public class App {
    ...
    private final TenmoService tenmoServices = new TenmoService();
    ...
    private void mainMenu() {
        ...
        while (!leaveApp) {
            ...
            switch(menuSelection) {
                ...
                tenmoServices.viewCurrentBalance(currentUser);//    call service to perform the process
                break;                                        //    and exit switch statement
                }
                case View_Your_Past_Transfers: {                    // If option to see transfer history is chosen...
                    tenmoServices.viewTransferHistory(currentUser); //    call service to perform the process
                    break;                                          //    and exit switch statement
                }
                case View_Your_Pending_Requests: {                  // If option to see pending transfer requests is chosen...
                    tenmoServices.viewPendingRequests(currentUser); //    call service to perform the process
                    break;                                          //    and exit switch statement
                }
                case Send_TE_Bucks: {                              // If option to see transfer money is chosen...
                    tenmoServices.sendBucks(currentUser);          //    call service to perform the process
                    break;                                         //    and exit switch statement
                }
                case Request_TE_Bucks:  {                          // If option to see request money is chosen...
                    tenmoServices.requestBucks(currentUser);       //    call service to perform the process
                    break;                                         //    and exit switch statement
                }
